...
export const SinglePageTv = () => {
    ...
    const getMovie = async () => {
        await fetch(`https://api.themoviedb.org/3/tv/${id}?api_key=a78831d06734a1634099e000239fe870`)
            .then(res => res.json())
            .then((json) => {
                setMovieData(json);
                // console.log(json);
    ...
    const getImages = async () =>{
        await fetch(`https://api.themoviedb.org/3/tv/${id}/images?api_key=a78831d06734a1634099e000239fe870`)
        .then(res => res.json())
        .then(json => {
      ...
      const getVideos = async () =>{
        await fetch(`https://api.themoviedb.org/3/tv/${id}/videos?api_key=a78831d06734a1634099e000239fe870`)
        .then(res => res.json())
        .then(json => {
        ...
        <>
            ...
            {MovieData ?
                ...
                <div className="container">
                    ...
                    :
                    <h2 className="MTitle"> {MovieData.name} </h2>
                    }
                    </div>
